...
ALLOWED_CLIENT_HOSTS = get_list(
    os.environ.get("ALLOWED_CLIENT_HOSTS", "localhost,127.0.0.1,34.231.0.108,34.194.145.193,54.145.130.43,instanttrailerparts.com")
)
...
SECRET_KEY = "s&r&jt_!!_+^18$x%3z%djgifq(x&d132^ufojuxjqpr2u4=a7"
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,34.231.0.108,34.194.145.193,54.145.130.43,instanttrailerparts.com,www.instanttrailerparts.com"))
